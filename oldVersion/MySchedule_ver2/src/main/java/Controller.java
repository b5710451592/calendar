...
public class Controller {
    ...
    public void loadData(ObservableList<String> items, ListView listView ) throws SQLException {
        ...
        try {
            ...
            MySchedule schedule= new MySchedule(resultSet.getString(1),
                    resultSet.getString(2),resultSet.getString(3));
            while(resultSet.next()) {
                items.add(schedule.getTextDate()+ schedule.getTextTime()+schedule.getTextNote());
            }
